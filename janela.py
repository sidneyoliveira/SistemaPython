...
user1 = customtkinter.CTkLabel(login, text="Usuario",
                                font= ('poppins medium', 15),
                                text_color="#3F84CB",
                                )

user1.place(x=420, y=70)

user = customtkinter.CTkEntry(login, placeholder_text="Digite aqui seu Usuario",
                              width=180, height=40,
                              border_width=2,
                              border_color='#dddddd',
                              corner_radius=30,
...
senha1 = customtkinter.CTkLabel(login, text="Senha",
                                font= ('poppins medium', 15),
                                text_color="#3F84CB",
                                compound='bottom')

senha1.place(x=420, y=150)
...
botao_login = customtkinter.CTkButton(login, text="Login", command=clique, width=70, height=30)
